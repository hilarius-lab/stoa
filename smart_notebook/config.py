...
MUTATION_TARGET_MIN_CONFIDENCE = min(1.0,max(0.0,float(os.getenv("MUTATION_TARGET_MIN_CONFIDENCE","0.85"))))
MUTATION_ACTION_MIN_CONFIDENCE = min(1.0,max(0.0,float(os.getenv("MUTATION_ACTION_MIN_CONFIDENCE","0.85"))))
MUTATION_PART_MIN_CONFIDENCE = min(1.0,max(0.0,float(os.getenv("MUTATION_PART_MIN_CONFIDENCE","0.85"))))
STT_WEAK_WORD_THRESHOLD = min(1.0,max(0.0,float(os.getenv("STT_WEAK_WORD_THRESHOLD","0.5"))))
STT_SECOND_PASS_TEMPERATURE = min(1.0,max(0.0,float(os.getenv("STT_SECOND_PASS_TEMPERATURE","0.2"))))
