...
Code implementiert, Live-Test noch ausstehend:
- [ ] A2 – Ingestion Chunks (Code bereit)
- Idempotenter Upload via client_chunk_id
- Eindeutige sequence pro Session
- Optionaler Quell-Zeitbereich in Millisekunden
- SHA-256 Content Hash
- 409 bei widersprüchlichem Retry oder Sequence-Konflikt
- Late Uploads nach Session-Finish erlaubt

Nach bestandenem Live-Test wird A2 als abgeschlossen markiert und A3 begonnen.
