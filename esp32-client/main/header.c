...
void header_draw(unsigned char *canvas, const header_state *state) {
     ...
     * itself is just one of the five choices, marked the same way as the
    ...
    /* The five views sit in the row permanently. The active one carries a
    ...
    static const icon_id views[5] = {
        ICON_HOME, ICON_TASK, ICON_LIST, ICON_HISTORY, ICON_SETTINGS
    };
