...
| Detail | `GET /api/client/v1/entities/{type}/{uuid}` | vollständige Session-Artifact-, Session-Topic- oder Question-Ansicht | `ENTITY_NOT_FOUND`; unbekannter Typ ist nicht erratbar |
